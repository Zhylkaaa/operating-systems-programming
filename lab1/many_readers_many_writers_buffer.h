...
#ifndef SYSTEMPROGRAMMING_MANY_READERS_MANY_WRITERS_BUFFER_H
#define SYSTEMPROGRAMMING_MANY_READERS_MANY_WRITERS_BUFFER_H
...
#endif //SYSTEMPROGRAMMING_MANY_READERS_MANY_WRITERS_BUFFER_H
